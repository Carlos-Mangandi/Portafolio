<template>
    <div class="text-center">
        ...
        <div class="flex flex-wrap items-center justify-center md:justify-center">   
            ...
            <a class="p-2">
                <img src="https://img.shields.io/badge/GIT-E44C30?style=for-the-badge&logo=git&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>  
            <a class="p-2">
                <img src="https://img.shields.io/badge/.NET-5C2D91?style=for-the-badge&logo=.net&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>     
            <a class="p-2">
                <img src="https://img.shields.io/badge/C%23-239120?style=for-the-badge&logo=c-sharp&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>  
            <a class="p-2">
                <img src="https://img.shields.io/badge/Node.js-43853D?style=for-the-badge&logo=node.js&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>  
            <a class="p-2">
                <img src="https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>  
            <a class="p-2">
                <img src="https://img.shields.io/badge/Microsoft%20SQL%20Server-CC2927?style=for-the-badge&logo=microsoft%20sql%20server&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>  
            <a class="p-2">
        ...
        <div class="flex flex-wrap items-center justify-center md:justify-center">
            ...
            <a class="p-2">
                <img src="https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a> 
            <a class="p-2">
                <img src="https://img.shields.io/badge/CSS3-1572B6?style=for-the-badge&logo=css3&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a> 
            <a class="p-2">
                <img src="https://img.shields.io/badge/Bootstrap-563D7C?style=for-the-badge&logo=bootstrap&logoColor=white" class="mr-[10px] md:w-auto md:h-auto h-8">
            </a>
            <a class="p-2">
